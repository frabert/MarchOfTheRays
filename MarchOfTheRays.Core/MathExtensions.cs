...
namespace MarchOfTheRays.Core
{
    public static class MathExtensions
    {
        ...
        public static Vector3 Ceiling(Vector3 a) => Map(Math.Ceiling, a);
        ...
        public static Vector3 Sqrt(Vector3 a) => Map(Math.Sqrt, a);
        ...
        public static float Ceiling(float a) => Map(Math.Ceiling, a);
